  ...
  return (
    <React.Fragment>
      <div className=" h-fit flex md:flex-col  bg-gray-300 shadow-lg rounded-lg justify-start md:max-w-md md:w-auto xl:max-w-md xl:w-auto  hover:shadow-md delay-100 duration-100 overflow-hidden">
        ...
        />
        <div>
          <div className="mt-4 m-4 font-serif font-semibold text-gray-800 text-2xl text-left text-clip text-">
            {title}
          </div>
          <div
            className="text-left  m-4 text-purple-500 font-bold 
        "
          >
            {description}
          </div>
          <div className="text-left  m-4 underline hover:font-bold  hover:delay-100 duration-150 ease-in-out">
            {prices}
          </div>
        </div>
        <div className="m-4">
